    ...
    <div className={`min-h-screen flex flex-col bg-background ${lato.className}`}>
      ...
      <main className="flex-grow pt-20 sm:pt-24 md:pt-32">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
          <h1 className={`text-3xl sm:text-4xl lg:text-5xl font-bold mb-8 text-black ${inter.className}`}>Privacy Policy</h1>
          ...
          <div className={`prose prose-lg max-w-none ${lato.className}`}>
            ...
            <h2 className={`text-2xl font-semibold mb-4 mt-8 ${inter.className}`}>Information We Collect</h2>
            <p className="mb-4 text-gray-700">Lock-in collects minimal data necessary to provide our focus assistance service. This includes:</p>
            <ul className="list-disc pl-6 mb-6 text-gray-700">
              <li>Usage patterns and focus session data</li>
              <li>App performance metrics</li>
              <li>Device information for compatibility</li>
            </ul>
            
            <h2 className={`text-2xl font-semibold mb-4 mt-8 ${inter.className}`}>How We Use Your Data</h2>
            <p className="mb-4 text-gray-700">We use your data solely to:</p>
            <ul className="list-disc pl-6 mb-6 text-gray-700">
              <li>Provide personalized focus coaching</li>
              <li>Improve app performance and features</li>
              <li>Send important updates and notifications</li>
            </ul>
            
            <h2 className={`text-2xl font-semibold mb-4 mt-8 ${inter.className}`}>Data Security</h2>
            <p className="mb-6 text-gray-700">Your data is encrypted and stored securely. We never sell or share your personal information with third parties.</p>
            
            <h2 className={`text-2xl font-semibold mb-4 mt-8 ${inter.className}`}>Contact Us</h2>
            <p className="text-gray-700">For privacy concerns, contact us at <a href="mailto:support@lock-in.ai" className="text-blue-600 hover:underline">support@lock-in.ai</a></p>
          </div>
        </div>
      </main>
